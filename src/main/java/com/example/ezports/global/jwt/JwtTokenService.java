...
import static com.example.ezports.global.consts.EzportsStatic.*;
...
public class JwtTokenService {
    ...
    private Jws<Claims> getJws(String token) {
        try {
            ...
            throw new GeneralException(GlobalErrorCode.TOKEN_EXPIRED);
        } catch (Exception e) {
