package com.example.ezports.global.email;

import com.example.ezports.global.config.RedisUtil;
...
public class EmailService {
    ...
    public String joinEmail(String email) {
        ...
        String content =
                "EZports를 방문해주셔서 감사합니다." + 	//html 형식으로 작성 !
                        "<br><br>" +
                        "인증 번호는 " + code + "입니다." +
                        "<br>" +
    ...
    public void sendMail(String setFrom, String toMail, String title, String content) {
        ...
        redisUtil.setDataExpire(Integer.toString(code), toMail, 60L);
    }

    public void checkCode(String email,String code){
        String savedEmail = redisUtil.getData(code);
        if((savedEmail== null) || (!savedEmail.equals(email))){
            throw new GeneralException(GlobalErrorCode.NOT_VALID_CODE);
        }
    }
}
